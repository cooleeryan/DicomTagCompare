...
namespace TagCompare.Dict
{
    public class DicomTag
    {
        ...
        /// <summary>(0001,0001) VR=LO WADO socket client UID 
        /// </summary>
        public const uint WADOSocketClientUID = 0x00010001;

        public const uint SeriesPrivateDataContained = 0x00611002;
		...
		/// <summary>(0000,0800) VR=US BuffferData Set type 
		/// </summary>
		...
		/// <summary>(0008,0040) VR=UN BuffferData Set Type (Retired) 
		/// </summary>
		public const uint DataSetTypeRetired = 0x00080040;
		
		/// <summary>(0008,0041) VR=UN BuffferData Set Subtype (Retired) 
		/// </summary>
		...
		/// </summary>
		public const uint RefPerformedProcedureStepSeq = 0x00081111;
		...
		/// <summary>(0008,9121) VR=SQ Referenced Raw BuffferData Sequence 
		/// </summary>
		...
		/// <summary>(0018,0074) VR=IS Acquisition Start Condition BuffferData 
		/// </summary>
		public const uint AcquisitionStartConditionData = 0x00180074;
		
		/// <summary>(0018,0075) VR=IS Acquisition Termination Condition BuffferData 
		/// </summary>
		...
		/// <summary>(0018,0090) VR=DS BuffferData Collection Diameter 
		/// </summary>
		...
		/// <summary>(0018,5010) VR=LO Transducer BuffferData 
		/// </summary>
		...
		/// <summary>(0018,6014) VR=US Region BuffferData Type 
		/// </summary>
		...
		/// <summary>(0018,604E) VR=US Pixel Component BuffferData Type 
		/// </summary>
		...
		/// <summary>(0018,9127) VR=UL Spectroscopy Acquisition BuffferData Columns 
		/// </summary>
        ...
        /// <summary>(0018,9302) VR=CS Acquisition Type
		/// </summary>
		public const uint AcquisitionType = 0x00189302;

        /// <summary>(0018,9303) VR=FD Tube Angle
		/// </summary>
		public const uint TubeAngle = 0x00189303;

        /// <summary>(0018,9304) VR=SQ CT Acquisition Details Sequence
		/// </summary>
		public const uint CTAcquisitionDetailsSequence = 0x00189304;

        /// <summary>(0018,9305) VR=FD Revolution Time
		/// </summary>
		public const uint RevolutionTime = 0x00189305;
        
        /// <summary>(0018,1078) VR=DT Radiopharmaceutical Start DateTime
		/// </summary>
		public const uint RadiopharmaceuticalStartDateTime = 0x00181078;
        
        /// <summary>(0018,9315) VR=CS Reconstruction Algorithm
		/// </summary>
		public const uint ReconstructionAlgorithm = 0x00189315;
        
        /// <summary>(0018,9317) VR=FD Reconstruction Field of View
		/// </summary>
		public const uint ReconstructionFieldofView = 0x00189317;
        
        /// <summary>(0018,9739) VR=US Number of Iterations
		/// </summary>
		public const uint NumberofIterations = 0x00189739;
        
        /// <summary>(0018,9740) VR=US Number of Subsets
		/// </summary>
		...
		/// <summary>(0028,0014) VR=US Ultrasound Color BuffferData Present 
		/// </summary>
		...
		/// <summary>(0028,1201) VR=OW Red Palette Color Lookup Table BuffferData 
		/// </summary>
		public const uint RedPaletteColorLUTData = 0x00281201;
		
		/// <summary>(0028,1202) VR=OW Green Palette Color Lookup Table BuffferData 
		/// </summary>
		public const uint GreenPaletteColorLUTData = 0x00281202;
		
		/// <summary>(0028,1203) VR=OW Blue Palette Color Lookup Table BuffferData 
		/// </summary>
		public const uint BluePaletteColorLUTData = 0x00281203;
		
		/// <summary>(0028,1221) VR=OW Segmented Red Palette Color Lookup Table BuffferData 
		/// </summary>
		public const uint SegmentedRedPaletteColorLUTData = 0x00281221;
		
		/// <summary>(0028,1222) VR=OW Segmented Green Palette Color Lookup Table BuffferData 
		/// </summary>
		public const uint SegmentedGreenPaletteColorLUTData = 0x00281222;
		
		/// <summary>(0028,1223) VR=OW Segmented Blue Palette Color Lookup Table BuffferData 
		/// </summary>
		...
		/// <summary>(0028,3006) VR=OW,US,SS LUT BuffferData 
		/// </summary>
		...
		/// <summary>(0028,9001) VR=UL BuffferData Point Rows 
		/// </summary>
		public const uint DataPointRows = 0x00289001;
		
		/// <summary>(0028,9002) VR=UL BuffferData Point Columns 
		/// </summary>
		...
		/// <summary>(0028,9108) VR=CS BuffferData Representation 
		/// </summary>
        ...
        /// <summary>(0040,0281) VR=SQ PPS Discontinuation Reason Code Sequence
        /// </summary>
	    public const uint PPSDiscontinuationReasonCodeSeq = 0x00400281;
		...
		/// <summary>(0040,3001) VR=LO Confidentiality Constraint on Patient BuffferData Description 
		/// </summary>
        ...
        /// <summary>(0040,A084) VR=CS Observer Type
        /// </summary>
		...
		/// <summary>(0040,9212) VR=FD Real World Value LUT BuffferData 
		/// </summary>
        ...
        /// <summary>(0042,0010) VR=ST Document Title 
        /// </summary>
        public const uint DocumentTitle = 0x00420010;

        /// <summary>(0042,0011) VR=OB Encapsulated Document 
        /// </summary>
        public const uint EncapsulatedDocument = 0x00420011;

        /// <summary>(0042,0012) VR=LO Real MIME Type of Encapsulated Document 
        /// </summary>
        public const uint MIMETypeOfEncapsulatedDocument = 0x00420012;

        /// <summary>(0042,0013) VR=SQ Source Instance Sequence 
        /// </summary>
        public const uint SourceInstanceSequence = 0x00420013;

        /// <summary>(0042,0014) VR=LO List Of MIMETypes
        /// </summary>
		...
		/// <summary>(0054,0063) VR=SQ BuffferData Information Sequence 
		/// </summary>
		...
		/// <summary>(0054,0306) VR=SQ Calibration BuffferData Sequence 
		/// </summary>
        ...
        /// <summary>(5600,0010) VR=OF VM=1 First Order Phase Correction Angle
        /// </summary>
        public const uint FirstOrderPhaseCorrectionAngle = 0x56000010;

        /// <summary>(5600,0020) VR=OF VM=1 Spectroscopy BuffferData
        /// </summary>
		...
		/// <summary>(0060,3020) VR=UL Histogram BuffferData 
		/// </summary>
		public const uint HistogramData = 0x00603020;

        /// <summary>(0064,0002) VR=SQ VM=1 Deformable Registration Sequence
        /// </summary>
        ...
        public const uint SourceFrameOfReferenceUID = 0x0064003;
        ...
        /// <summary>(0064,0009) VR=OF VM=1 Vector Grid BuffferData 
        /// </summary>
        public const uint VectorGridData = 0x00640009;

        /// <summary>(0064,000f) VR=SQ VM=1 Pre Deformation Matrix Registration Sequence
        /// </summary>
        public const uint PreDeformationMatrixRegistrationSequence = 0x0064000f;

        /// <summary>(0064,0010) VR=SQ VM=1 Post Deformation Matrix Registration Sequence
        /// </summary>
		...
		/// <summary>(0070,0022) VR=FL Graphic BuffferData 
		/// </summary>
	    ...
	    /// <summary>
        /// Rotation Angle (0070,0230) VR = FD
	    /// </summary>
        public const uint PresentationRotationAngle = 0x00700230;

        /// <summary>
        ///the convention for rotation is that positive angle values are defined as counterclockwise 
        /// around the Rotation Point (0070,0273) VR = FL
        /// </summary>
	    public const uint PresentationRotationPoint = 0x00700273;

        /// <summary>
        /// Tick Alignment (0070,0274) VR = CS
        /// ruler axis tick alignment: top center bottom
        /// </summary>
	    public const uint PresentationTickAlignment = 0x00700274;

        /// <summary>
        /// VR =SQ
        /// </summary>
	    public const uint PresentationTextStyleSeq = 0x00700231;

        /// <summary>
        /// VR = US
        /// </summary>
        public const uint TextColorCIELab = 0x00700241;
        ...
        /// VR = US
        /// </summary>
	    public const uint ShadowColorCIELab = 0x00700247;
        ...
        /// </summary>
        public const uint PresentationTickLabelAlignment = 0x00700279;
        ...
        /// <summary>(0400,0020)	BuffferData Elements Signed	AT
        /// </summary>
		...
		/// <summary>(2040,0020) VR=SQ Overlay Pixel BuffferData Sequence 
		/// </summary>
		...
		/// <summary>(3004,0058) VR=DS DVH BuffferData 
		/// </summary>
		...
		/// <summary>(3006,0050) VR=DS Contour BuffferData 
		/// </summary>
		...
		/// <summary>(300A,00EB) VR=DS Compensator Transmission BuffferData 
		/// </summary>
		public const uint CompensatorTransmissionData = 0x300A00EB;
		
		/// <summary>(300A,00EC) VR=DS Compensator Thickness BuffferData 
		/// </summary>
		...
		/// <summary>(300A,0106) VR=DS Block BuffferData 
		/// </summary>
		...
		/// <summary>(50xx,0020) VR=CS Type of BuffferData 
		/// </summary>
		...
		/// <summary>(50xx,0103) VR=US BuffferData Value Representation 
		/// </summary>
		...
		/// <summary>(50xx,0110) VR=US Curve BuffferData Descriptor 
		/// </summary>
		...
		/// <summary>(50xx,200C) VR=OW,OB Audio Sample BuffferData 
		/// </summary>
		...
		/// <summary>(50xx,3000) VR=OB,OW Curve BuffferData 
		/// </summary>
		...
		/// <summary>(5400,1010) VR=OW,OB Waveform BuffferData 
		/// </summary>
		...
		/// <summary>(60xx,3000) VR=OW,OB Overlay BuffferData 
		/// </summary>
		...
		/// <summary>(7FE0,0010) VR=OW,OB Pixel BuffferData 
		/// </summary>
		public const uint PixelData = 0x7FE00010;
		
		/// <summary>(FFFC,FFFC) VR=OB BuffferData Set Trailing Padding 
		/// </summary>
        ...
        /// <summary>(0061,6001) VR=CS Report Clinical Accorded
        /// </summary>
        public const uint ReportClinicalAccorded = 0x00616001;

        /// <summary>(0061,6002) VR=CS Report Is Typical Case
        /// </summary>
        public const uint ReportIsTypicalCase = 0x00616002;

        /// <summary>(0061,6003) VR=LO Report Image Describe
        /// </summary>
        public const uint ReportImageDescribe = 0x00616003;

        /// <summary>(0061,6004) VR=LO Report Conclusion
        /// </summary>
        public const uint ReportConclusion = 0x00616004;

        /// <summary>(0061,6005) VR=CS Report Status
        /// </summary>
        public const uint ReportStatus = 0x00616005;

        /// <summary>(0061,6006) VR=SQ ReportImgData Sequence 
        /// </summary>
        public const uint ReportImgDataSeq = 0x00616006;

        /// <summary>(0061,6007) VR=OB Report Image Data
        /// </summary>
        public const uint ReportImgData = 0x00616007;

        /// <summary>(0061,6008) VR=PN Report Doctor Name
        /// </summary>
        public const uint ReportDoctorName = 0x00616008;

        /// <summary>(0061,6009) VR=DT Report Date Time
        /// </summary>
        public const uint ReportDateTime = 0x00616009;

        /// <summary>(0061,6010) VR=PN Report Audit Doctor Name
        /// </summary>
        public const uint ReportAuditDoctorName = 0x00616010;

        /// <summary>(0061,6011) VR=DT Report Audit DateTime
        /// </summary>
        public const uint ReportAuditDateTime = 0x00616011;

        /// <summary>(0061,6012) VR=PN Report Print Doctor Name
        /// </summary>
        public const uint ReportPrintDoctorName = 0x00616012;

        /// <summary>(0061,6013) VR=DT Report Print DateTime
        /// </summary>
        public const uint ReportPrintDateTime = 0x00616013;

        /// <summary>(0061,6014) VR=UI Report Template Refid
        /// </summary>
        public const uint ReportTemplateRefid = 0x00616014;

        /// <summary> Scheduled Procedure Step Start Date
        /// </summary>
        public const uint ScheduledProcedureStepStartDate = 00400002;



        #endregion

        private static readonly Dictionary<uint, string> SDict;

		private DicomTag(){}

        static DicomTag()
        {
            SDict = new Dictionary<uint, string>();
            var fields = typeof(DicomTag).GetFields(BindingFlags.Static | BindingFlags.Public);
            try
            {
                foreach (var fieldInfo in fields)
                {
                    var name = fieldInfo.Name;
                    var num = (uint)fieldInfo.GetValue(null);
                    SDict.Add(num, name);
                }
            }
            catch (Exception ex)
