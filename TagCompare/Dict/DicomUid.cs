namespace TagCompare.Dict
{
    ...
    public class DicomUid
    {
        ...
        #region TransferSyntax definitions

        /// <summary>SOP Class: Verification SOP Class [PS 3.4]
        /// </summary>
        public const string VerificationSOPClass = "1.2.840.10008.1.1";

		/// <summary>Transfer Syntax: Implicit VR Little Endian: Default Transfer Syntax for DICOM [PS 3.5]
		/// </summary>
		public const string ImplicitVRLittleEndian = "1.2.840.10008.1.2";
		
		/// <summary>Transfer Syntax: Explicit VR Little Endian [PS 3.5]
		/// </summary>
		public const string ExplicitVRLittleEndian = "1.2.840.10008.1.2.1";
		
		/// <summary>Transfer Syntax: Deflated Explicit VR Little Endian [PS 3.5]
		/// </summary>
		...
		/// <summary>SOPClass: Raw BuffferData Storage 
		/// </summary>
		...
		/// <summary>SOPClass: IsEncapsulated PDF Storage
		/// </summary>
		public const string EncapsulatedPDFStorage = "1.2.840.10008.5.1.4.1.1.104.1";

		/// <summary>SOPClass: IsEncapsulated CDA Storage
		/// </summary>
